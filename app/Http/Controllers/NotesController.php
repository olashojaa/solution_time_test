...
class NotesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Notification::send($user, new NoteCreatedNotification($note));
    ...
    //////////////////////////////////////////////////////////////////////////////////
    public function datatable(NotesDataTable $dataTable)
      {
          return $dataTable->render('dashboard.notes.datatable');
